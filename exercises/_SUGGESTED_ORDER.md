...
1. [eng_to_swe.rb](eng_to_swe.rb)
1. [run_length_encode.rb](run_length_encode.rb)
1. [run_length_decode.rb](run_length_decode.rb)
1. [rot13.rb](rot13.rb)
1. [rot_n.rb](rot_n.rb)
1. [to_french.rb](to_frenc.rb)
1. [to_roman.rb](to_roman.rb)
1. [from_roman.rb](from_roman.rb)
1. [from_french.rb](from_french.rb)
1. [person.rb](person.rb)
1. [die.rb](die.rb)
1. [die_sides.rb](die_sides.rb)
1. [die_labels.rb](die_labels.rb)
1. [eng_to_swe_cla.rb](eng_to_swe.rb)
1. [board.rb](board.rb)
1. [hot_or_cold.rb](hot_or_cold.rb)
